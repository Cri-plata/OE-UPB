...
def gen_fake_person():
    ...
    return {
        "NUMERO_DOCUMENTO": random.randint(1000000000, 1999999999), # Como ENTERO para no romper la columna int64
...
# Castear absolutamente todo a object para evitar el infierno de Pandas
